...
namespace KadiovVehicleCare.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [StringLength(100, ErrorMessage = "Полето „Парола“ трябва да е между {2} и {1} символа.", MinimumLength = 6)]
        ...
        private IdentityUser CreateUser()
        {
            ...
            catch
            {
                throw new InvalidOperationException(
                    $"Не може да се създаде инстанция на '{nameof(IdentityUser)}'. " +
                    $"Уверете се, че '{nameof(IdentityUser)}' не е абстрактен клас и има конструктор без параметри, " +
                    $"или override-нете страницата за регистрация в /Areas/Identity/Pages/Account/Register.cshtml");
            }
        }
        ...
        private IUserEmailStore<IdentityUser> GetEmailStore()
        {
            ...
            {
                throw new NotSupportedException("Стандартният интерфейс изисква store с поддръжка на имейл.");
            }
